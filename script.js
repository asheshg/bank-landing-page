...
const translationDictionary = {
  hi: {
    ...
    "India is building for generations. SBI is built to stand with every generation.": "भारत पीढ़ियों के लिए निर्माण कर रहा है। SBI हर पीढ़ी के साथ खड़े रहने के लिए बनी है।",
    "Years of trust": "वर्षों का भरोसा",
    "Customers served": "ग्राहकों की सेवा",
    "Branches": "शाखाएं",
    "ATMs & CSPs": "ATM और CSP",
    "Bank safely": "सुरक्षित बैंकिंग",
    "Security, fraud awareness and verified digital journeys.": "सुरक्षा, धोखाधड़ी जागरूकता और सत्यापित डिजिटल यात्राएं।",
    "Reach everywhere": "हर जगह पहुंच",
    "Branch, ATM, CSP and locker access across India.": "भारत भर में शाखा, ATM, CSP और लॉकर सुविधा।",
    "Move digitally": "डिजिटल रूप से आगे बढ़ें",
    "YONO, UPI and online banking for everyday financial tasks.": "रोजमर्रा के वित्तीय कार्यों के लिए YONO, UPI और ऑनलाइन बैंकिंग।",
